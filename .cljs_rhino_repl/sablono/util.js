...
var x__82306__auto__ = (((x == null))?null:x);
var m__82307__auto__ = (sablono.util.to_str[goog.typeOf(x__82306__auto__)]);
if(!((m__82307__auto__ == null))){
return m__82307__auto__.call(null,x);
} else {
var m__82307__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__82307__auto____$1 == null))){
return m__82307__auto____$1.call(null,x);
} else {
...
var x__82306__auto__ = (((x == null))?null:x);
var m__82307__auto__ = (sablono.util.to_uri[goog.typeOf(x__82306__auto__)]);
if(!((m__82307__auto__ == null))){
return m__82307__auto__.call(null,x);
} else {
var m__82307__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__82307__auto____$1 == null))){
return m__82307__auto____$1.call(null,x);
} else {
...
var len__83814__auto___85836 = arguments.length;
var i__83815__auto___85837 = (0);
while(true){
if((i__83815__auto___85837 < len__83814__auto___85836)){
args__83829__auto__.push((arguments[i__83815__auto___85837]));

var G__85838 = (i__83815__auto___85837 + (1));
i__83815__auto___85837 = G__85838;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__83830__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq85835){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq85835));
});
...
var vec__85839 = cljs.core.name.call(null,k).split("-");
var seq__85840 = cljs.core.seq.call(null,vec__85839);
var first__85841 = cljs.core.first.call(null,seq__85840);
var seq__85840__$1 = cljs.core.next.call(null,seq__85840);
var first_word = first__85841;
var words = seq__85840__$1;
...
var m__$1 = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__85842){
var vec__85843 = p__85842;
var k = cljs.core.nth.call(null,vec__85843,(0),null);
var v = cljs.core.nth.call(null,vec__85843,(1),null);
...
return cljs.core.update.call(null,G__85846,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__85846;
}
} else {
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__80613__auto__ = x__$1.hasDomain();
if(cljs.core.truth_(or__80613__auto__)){
return or__80613__auto__;
} else {
