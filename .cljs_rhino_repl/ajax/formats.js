...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__85392){
var map__85393 = p__85392;
var map__85393__$1 = ((((!((map__85393 == null)))?((((map__85393.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__85393.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__85393):map__85393);
var request = map__85393__$1;
var response_format = cljs.core.get.call(null,map__85393__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
ajax.formats.accept_header = (function ajax$formats$accept_header(p__85398){
var map__85399 = p__85398;
var map__85399__$1 = ((((!((map__85399 == null)))?((((map__85399.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__85399.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__85399):map__85399);
var request = map__85399__$1;
var response_format = cljs.core.get.call(null,map__85399__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
