...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__84992){
var map__84993 = p__84992;
var map__84993__$1 = ((((!((map__84993 == null)))?((((map__84993.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__84993.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__84993):map__84993);
var handler = cljs.core.get.call(null,map__84993__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return (function (p1__84995_SHARP_){
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__80935__auto__ = p1__84995_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__84996){
var map__84997 = p__84996;
var map__84997__$1 = ((((!((map__84997 == null)))?((((map__84997.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__84997.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__84997):map__84997);
var request = map__84997__$1;
var interceptors = cljs.core.get.call(null,map__84997__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
...
var api = (function (){var or__80935__auto__ = new cljs.core.Keyword(null,"api","api",-899839580).cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__80935__auto__)){
return or__80935__auto__;
} else {
