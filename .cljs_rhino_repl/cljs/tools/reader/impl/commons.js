...
var G__86950 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__86950;
continue;
} else {
return ch;
...
var vec__86951 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__86951,(0),null);
return (match === s);
});
...
var len__80626__auto___86956 = arguments.length;
var i__80627__auto___86957 = (0);
while(true){
if((i__80627__auto___86957 < len__80626__auto___86956)){
args__80633__auto__.push((arguments[i__80627__auto___86957]));

var G__86958 = (i__80627__auto___86957 + (1));
i__80627__auto___86957 = G__86958;
continue;
} else {
}
break;
...
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__80634__auto__);
});
...
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq86954){
var G__86955 = cljs.core.first.call(null,seq86954);
var seq86954__$1 = cljs.core.next.call(null,seq86954);
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic(G__86955,seq86954__$1);
});

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__86959__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__86959 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__86960__i = 0, G__86960__a = new Array(arguments.length -  1);
while (G__86960__i < G__86960__a.length) {G__86960__a[G__86960__i] = arguments[G__86960__i + 1]; ++G__86960__i;}
  _ = new cljs.core.IndexedSeq(G__86960__a,0,null);
} 
return G__86959__delegate.call(this,rdr,_);};
G__86959.cljs$lang$maxFixedArity = 1;
G__86959.cljs$lang$applyTo = (function (arglist__86961){
var rdr = cljs.core.first(arglist__86961);
var _ = cljs.core.rest(arglist__86961);
return G__86959__delegate(rdr,_);
});
G__86959.cljs$core$IFn$_invoke$arity$variadic = G__86959__delegate;
return G__86959;
})()
;
});
