...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__82389__auto__,writer__82390__auto__,opt__82391__auto__){
return cljs.core._write.call(null,writer__82390__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__85594 = o;
(G__85594[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__85595__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__85595 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__85596__i = 0, G__85596__a = new Array(arguments.length -  0);
while (G__85596__i < G__85596__a.length) {G__85596__a[G__85596__i] = arguments[G__85596__i + 0]; ++G__85596__i;}
  args = new cljs.core.IndexedSeq(G__85596__a,0,null);
} 
return G__85595__delegate.call(this,args);};
G__85595.cljs$lang$maxFixedArity = 0;
G__85595.cljs$lang$applyTo = (function (arglist__85597){
var args = cljs.core.seq(arglist__85597);
return G__85595__delegate(args);
});
G__85595.cljs$core$IFn$_invoke$arity$variadic = G__85595__delegate;
return G__85595;
})()
;
} else {
...
if(cljs.core.truth_((function (){var and__80906__auto__ = !((jsprops == null));
if(and__80906__auto__){
var and__80906__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__85600 = jsprops;
(G__85600["defaultValue"] = value);

(G__85600["onChange"] = ((function (G__85600,v,value,on_change){
return (function (p1__85599_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__85599_SHARP_);
});})(G__85600,v,value,on_change))
);
...
var vec__85603 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__85603,(0),null);
var id = cljs.core.nth.call(null,vec__85603,(1),null);
var class$ = cljs.core.nth.call(null,vec__85603,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___85607 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___85607 == null)){
} else {
var key_85608 = temp__5461__auto___85607;
(jsprops["key"] = key_85608);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__85609 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__85609["name"] = c);
...
var len__83009__auto___85614 = arguments.length;
var i__83010__auto___85615 = (0);
while(true){
if((i__83010__auto___85615 < len__83009__auto___85614)){
args__83016__auto__.push((arguments[i__83010__auto___85615]));

var G__85616 = (i__83010__auto___85615 + (1));
i__83010__auto___85615 = G__85616;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__83017__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq85612){
var G__85613 = cljs.core.first.call(null,seq85612);
var seq85612__$1 = cljs.core.next.call(null,seq85612);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__85613,seq85612__$1);
});
...
break;
default:
var G__85619 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__85619;
continue;
...
var n__82775__auto___85621 = a.length;
var i_85622 = (0);
while(true){
if((i_85622 < n__82775__auto___85621)){
(a[i_85622] = reagent.impl.template.as_element.call(null,(a[i_85622])));

var G__85623 = (i_85622 + (1));
i_85622 = G__85623;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__82775__auto___85624 = a.length;
var i_85625 = (0);
while(true){
if((i_85625 < n__82775__auto___85624)){
var val_85626 = (a[i_85625]);
if((cljs.core.vector_QMARK_.call(null,val_85626)) && ((reagent.impl.template.key_from_vec.call(null,val_85626) == null))){
(o["no-key"] = true);
} else {
}

(a[i_85625] = reagent.impl.template.as_element.call(null,val_85626));

var G__85627 = (i_85625 + (1));
i_85625 = G__85627;
continue;
} else {
}
...
var ctx = ({});
var vec__85628 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__85628,(0),null);
var derefed = cljs.core.nth.call(null,vec__85628,(1),null);
...
var G__85631 = (cljs.core.count.call(null,argv) - first_child);
switch (G__85631) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__85631){
