...
var len__83009__auto___87729 = arguments.length;
var i__83010__auto___87730 = (0);
while(true){
if((i__83010__auto___87730 < len__83009__auto___87729)){
args__83016__auto__.push((arguments[i__83010__auto___87730]));

var G__87731 = (i__83010__auto___87730 + (1));
i__83010__auto___87730 = G__87731;
continue;
} else {
}
break;
...
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(argseq__83017__auto__);
});
...
markdown.common.freeze_string.cljs$lang$applyTo = (function (seq87728){
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq87728));
});
...
var G__87734 = cljs.core.reduce.call(null,((function (text,state,matches,temp__5455__auto__){
return (function (s,r){
...
return (function (p1__87732_SHARP_){
return cljs.core.get.call(null,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__87732_SHARP_,p1__87732_SHARP_);
});})(text,state,matches,temp__5455__auto__))
);
});})(text,state,matches,temp__5455__auto__))
,text,matches);
var G__87735 = cljs.core.update.call(null,state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5455__auto__){
return (function (p1__87733_SHARP_){
return cljs.core.apply.call(null,cljs.core.dissoc,p1__87733_SHARP_,matches);
});})(text,state,matches,temp__5455__auto__))
);
text = G__87734;
state = G__87735;
...
var vec__87738 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__87741 = transformer.call(null,clojure.string.join.call(null,buf),cur_state);
var s = cljs.core.nth.call(null,vec__87741,(0),null);
var new_state = cljs.core.nth.call(null,vec__87741,(1),null);
...
var new_buf = cljs.core.nth.call(null,vec__87738,(0),null);
var new_state = cljs.core.nth.call(null,vec__87738,(1),null);
var G__87745 = cljs.core.vec.call(null,cljs.core.concat.call(null,out,cljs.core.seq.call(null,open),new_buf,cljs.core.seq.call(null,close)));
var G__87746 = cljs.core.PersistentVector.EMPTY;
var G__87747 = cljs.core.rest.call(null,tokens);
var G__87748 = cljs.core.assoc.call(null,new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__87745;
buf = G__87746;
tokens = G__87747;
cur_state = G__87748;
...
var G__87749 = out;
var G__87750 = cljs.core.into.call(null,buf,cljs.core.first.call(null,tokens));
var G__87751 = cljs.core.rest.call(null,tokens);
var G__87752 = cur_state;
out = G__87749;
buf = G__87750;
tokens = G__87751;
cur_state = G__87752;
...
var G__87753 = out;
var G__87754 = buf;
var G__87755 = cljs.core.rest.call(null,tokens);
var G__87756 = cljs.core.assoc.call(null,cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__87753;
buf = G__87754;
tokens = G__87755;
cur_state = G__87756;
...
var G__87757 = cljs.core.into.call(null,out,cljs.core.first.call(null,tokens));
var G__87758 = buf;
var G__87759 = cljs.core.rest.call(null,tokens);
var G__87760 = cur_state;
out = G__87757;
buf = G__87758;
tokens = G__87759;
cur_state = G__87760;
...
var num_hashes = cljs.core.count.call(null,cljs.core.filter.call(null,(function (p1__87761_SHARP_){
return cljs.core.not_EQ_.call(null," ",p1__87761_SHARP_);
}),cljs.core.take_while.call(null,(function (p1__87762_SHARP_){
return (cljs.core._EQ_.call(null,"#",p1__87762_SHARP_)) || (cljs.core._EQ_.call(null," ",p1__87762_SHARP_));
