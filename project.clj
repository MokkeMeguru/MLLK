(defproject fool "0.1.0-SNAPSHOT"
  ...
  :main ^:skip-aot fool.core
  :migratus {:store :database :db ~(get (System/getenv) "DATABASE_URL")}

  :git-dependencies [["https://github.com/MokkeMeguru/clj-arima.git"]]
                  ...
                  {:builds
                   {:app
                    {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                     :figwheel {:on-jsload "fool.core/mount-components"}
                     :compiler
                     {:main "fool.app"
                      :asset-path "/js/out"
                      :output-to "target/cljsbuild/public/js/app.js"
